...
### Presets
Presets can be found in the wiki page.

By default, it is the **Anarchy** preset, which may be incompatible with most mods. Use the **Lawful** preset for more compatibility. Both are equally stable.
...
### Are picky when it comes to support.
